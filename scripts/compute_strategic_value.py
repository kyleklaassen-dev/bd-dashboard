...
# ---------------------------------------------------------------------------
# Steps 2-3: Index data + score computation  → strategic_value_scoring.py (§3 split)
# ---------------------------------------------------------------------------
from strategic_value_scoring import (
    build_drug_index, build_dcs_index, build_deal_index, compute_score,
)
