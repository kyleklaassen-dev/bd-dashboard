...
NOTE: area_id='igf1r' — the TED tab uses areaIds=['igf1r'] per TAB_AREA_MAP.
...
# area_id = 'igf1r' (TED tab maps to igf1r per TAB_AREA_MAP)

SIGNALS = [
    # ── VELIGROTUG (Viridian) ─────────────────────────────────────────────────
    (
        'viridian', 'veligrotug', 'igf1r', 'regulatory',
    ...
    (
        'viridian', 'veligrotug', 'igf1r', 'clinical_update',
    ...
    (
        'viridian', 'veligrotug', 'igf1r', 'conference',
    ...
    # ── ELEGROBART (Viridian) ─────────────────────────────────────────────────
    (
        'viridian', 'elegrobart', 'igf1r', 'clinical_update',
    ...
    (
        'viridian', 'elegrobart', 'igf1r', 'conference',
    ...
    # ── OLN102 (Ollin Bio) ────────────────────────────────────────────────────
    (
        'ollin', 'oln102', 'igf1r', 'clinical_update',
    ...
    # ── SP-1351 (Septerna) ────────────────────────────────────────────────────
    (
        'septerna', 'sp-1351', 'igf1r', 'conference',
    ...
    (
        'septerna', 'sp-1351', 'igf1r', 'financing',
    ...
    # ── CRN12755 (Crinetics) ─────────────────────────────────────────────────
    (
        'crinetics', 'crn12755', 'igf1r', 'conference',
    ...
    # ── YB-101 (Yarrow Bio) ──────────────────────────────────────────────────
    (
        'yarrow', 'yb-101', 'igf1r', 'clinical_update',
    ...
    # ── LINSITINIB (Roche) ───────────────────────────────────────────────────
    (
        'roche', 'linsitinib', 'igf1r', 'clinical_update',
    ...
    (
        'roche', 'linsitinib', 'igf1r', 'conference',
    ...
    (
        'amgen', 'teprotumumab', 'igf1r', 'regulatory',
    ...
    (
        'amgen', 'teprotumumab', 'igf1r', 'clinical_update',
    ...
    (
        'immunovant', 'batoclimab', 'igf1r', 'clinical_update',
...
def main():
    parser = argparse.ArgumentParser(description='Seed competitive_signals for TED / IGF-1R landscape.')
