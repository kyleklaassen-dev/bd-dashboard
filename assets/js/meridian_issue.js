// ── MERIDIAN ISSUE / ARCHIVE ─────────────────────────────────────
// Extracted from app.js (Domain A2, §3 method — byte-identical relocation).
// Plain script loaded BEFORE app.js: loadMeridianIssue/renderMeridianIssue/
// toggle/closeMeridianArchive/selectMeridianIssue/_injectMeridianBridge stay global
// (index.html iframe onload/onclick + the tab registry call them). _sb is from core.js.
