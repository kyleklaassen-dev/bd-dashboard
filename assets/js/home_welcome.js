// ── HOME WELCOME — Live Clock + Full-Database Counter ─────────────
// Extracted from app.js (Domain A2, §3 method — byte-identical relocation).
// Self-contained IIFE. Loads AFTER app.js because it calls registerTab('home') at
// eval-time; all other refs (_sb core.js, openDrugModal, window.mlInit) resolve at runtime.
