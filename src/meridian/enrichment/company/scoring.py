#!/usr/bin/env python3
"""
Company completeness scoring (§3 company_enrichment split).
===========================================================
Extracted verbatim from company_enrichment.py. Computes a 0-100 enrichment
completeness score + tier + missing-field list for a company/area. Pure function.

TODO (dedupe, supervised): overlaps the compute_* scoring scripts — consolidate later.
"""
