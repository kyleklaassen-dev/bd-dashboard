...
- ✅ All 4 core writers tested: `tests/run_all.py` → 14 tests green. **Direct-write audit: drugs 0 / companies 0 / catalysts 0.**
- ⬜ Apply enforcement (`PROPOSED_drugwriter_enforcement.sql`) — needs Kyle + watch window. Extend the trigger pattern to companies/catalysts.
